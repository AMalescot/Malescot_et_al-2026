...
%% Description:
% function for recursive alignment of 2-photon images in a t-stack.
%aligned image(m).
%% Input:
%  - stack: a YXT image (only one channel). 
%  - idx: frame index of the stack. 
%  - optimizer, metric: can be obtained using "[optimizer, metric] =
%    imregconfig('monomodal');".
%  - fixedRefObj: results of imref2d on the first frame
%% Output:
...
%
% Adapted and modified by Éric Martineau - Université de Montreal
