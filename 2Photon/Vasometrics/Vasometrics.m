...
%
%% Input: 
%   - stack : time series with vessel-labeling channel in XYT format stack
...
%   - handle : axes handle to trace on. Leave empty on non-App scripts
%
%% Ouput: 
...
%
% Translated to Matlab by Éric Martineau - Université de Montréal
...
for t = 1:dims(3) % For loop on time dimension   
